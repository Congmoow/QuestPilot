  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-card border border-gray-200 bg-white p-6 shadow-popover dark:border-gray-700 dark:bg-gray-800',
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn('text-sm leading-6 text-gray-600 dark:text-gray-300', className)}
    {...props}
  />
));
...
>(({ className, variant = 'primary', loading, children, ...props }, ref) => (
  <AlertDialogPrimitive.Action ref={ref} asChild>
    <ActionButton variant={variant} loading={loading} className={className} {...props}>
      {children}
    </ActionButton>
