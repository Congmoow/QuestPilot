...
pub fn csv_select_file(window: WebviewWindow) -> Result<Option<String>, String> {
...
#[tauri::command(rename_all = "camelCase")]
pub fn csv_download_template(window: WebviewWindow) -> Result<serde_json::Value, String> {
...
#[tauri::command(rename_all = "camelCase")]
pub fn csv_parse_file(file_path: String) -> Result<serde_json::Value, String> {
